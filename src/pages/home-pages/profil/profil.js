                            ...
                            <Row className="mb-4 justify-content-center">
                              <Col style={{ textAlign: 'center' }}>
                                ...
                                <p className=" text-indigo">
                                  <NioMedia size="sm" icon="mail" className="me-2 text-indigo" /> {data.email}
                                </p>
                                < p className=" text-indigo">
                                  <NioMedia size="sm" icon="mobile" className="me-2 text-indigo" /> {data.phone}
                                </p>
                                <p className=" text-indigo">
                                  <NioMedia size="sm" icon="location" className="me-2 text-indigo" /> {data.country}
                                </p>
                              </Col>
                            </Row>
                            <Row className="mb-4">
